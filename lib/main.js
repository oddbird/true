...
module.exports.runSass = function (options, describe, it) {
  ...
  printAssertions(sass.renderSync(options).css, describe, it);
};

var printAssertions = module.exports.printAssertions = function (results, describe, it) {
  var assert = require('assert');
  var modules = parse(results.toString());
