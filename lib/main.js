...
const falsyValues = function (item) {
  return Boolean(item);
};
...
const splitSelectorAndProperties = function (blocks) {
...
const removeNewLines = function (cssString) {
  return cssString.replace(/\n/g, '');
};

const cssStringToArrayOfRules = function (cssString) {
...
const startsWith = function (text, token) {
